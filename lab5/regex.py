...
matches = re.findall(r"abb|abbb", text)
print(matches)
...
aaa = "altair_sukashev_aibat_maratov" 
matches = re.split("_", aaa)
asa = "".join([b.capitalize() for b in matches])
print(asa)

#8

print(re.findall("([a-zA-Z][^A-Z]*)", text))
...
lst = re.findall("([A-Z][]a-z0-9]+)", text)
