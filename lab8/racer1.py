...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.transform.scale(pygame.image.load(f"coin.png"), (30 + 5 * self.weight, 30 + 5 * self.weight))
...
while True:
    ...
    for coin in coins:
        ...
        if coin.counter >= 60 * coin.weight:
            ...
            coin.image = pygame.transform.scale(pygame.image.load(f"coin.png"), (30 + 5 * coin.weight, 30 + 5 * coin.weight))
